...
<style>
    ...
    .header h1 { margin: 0; font-size: 2.2rem; font-weight: 700; color: #fff; text-shadow: 1px 1px 3px rgba(0,0,0,0.3); }
    .header p { margin: 5px 0 0; color: #f0f8ff; font-size: 1.1rem; }
    ...
    th .sort-icon { margin-left: 5px; opacity: 0.7; }
    ...
    .empty-state i { font-size: 3.5rem; margin-bottom: 20px; color: #0072ff; }
    ...
    @media (max-width: 768px) {
        ...
        .sidebar { width: 100%; height: auto; position: relative; flex-direction: row; justify-content: space-around; padding: 10px 0; }
...
<body>
    ...
    <div class="main-content">
        ...
        %>
            <div style="background-color: #f8d7da; color: #721c24; padding: 15px; border-radius: 8px; border: 1px solid #f5c6cb;"><%= errorMessage %></div>
        <%
